...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column" style="margin-left: 200px;width:70%;">
            ...
            <form class="form-horizontal" role="form" onsubmit="return validateForm()" id="login-form" action="/admin/submitPassword" method="post" data-toggle="validator" name="pform">
