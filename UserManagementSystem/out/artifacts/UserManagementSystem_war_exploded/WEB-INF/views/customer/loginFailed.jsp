...
<div class="container ">
    <div class="row clearfix">
        ...
        <div class="col-md-12 column" >
            ...
            <form class="form-horizontal" role="form" id="login-form" action="/customer/customer-login" method="post" data-toggle="validator">
                <br/>
                <h4 id="login-type" style="margin-left: 520px">用户登录</h4>
                <br/>
                ...
                <div class="form-group" style="margin-left: 160px">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <button type="button" class="btn btn-primary btn-default" style="margin-left: 280px"><a href="/customer/register">Register</a></button>
                    </div>
                </div>
            </form>
        </div>
